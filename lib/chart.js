...
(function(prefix, name, angular, google) {
  ...
  mod = angular.module(name, [function() {}]);
  mod.value(name + '.config', {});
  mod.service('GoogleLibLoader', [
  ...
  return mod.directive(prefix + 'Gauge', [
    name + '.config', 'GoogleLibLoader', function(config, loader) {
      var toDataTable;

      toDataTable = function(data, title) {
        return google.visualization.arrayToDataTable([['Label', 'Value'], [title, data]]);
      };
      return {
        restrict: 'E',
        link: function(scope, ele, attrs) {
